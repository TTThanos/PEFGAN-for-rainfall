...
def main(year, time_windows):
    ...
    np.save("/scratch/iu60/yl3101/DESRGAN/new_crps/save/climatology/climatology_" + str(year) +
            "_all_lead_time_windows_" + str((time_windows - 1) * 2 + 1), np.array(crps_ref))
    np.save("/scratch/iu60/yl3101/DESRGAN/new_crps/save/climatology/log_climatology_" + str(year) +
                "_all_lead_time_windows_" + str((time_windows - 1) * 2 + 1), np.array(log_crps_ref))
    np.save("/scratch/iu60/yl3101/DESRGAN/new_crps/save/climatology/prob95_climatology_" + str(year) +
                "_all_lead_time_windows_" + str((time_windows - 1) * 2 + 1), np.array(Brier95))
    np.save("/scratch/iu60/yl3101/DESRGAN/new_crps/save/climatology/prob99_climatology_" + str(year) +
                "_all_lead_time_windows_" + str((time_windows - 1) * 2 + 1), np.array(Brier99))
    np.save("/scratch/iu60/yl3101/DESRGAN/new_crps/save/climatology/mae_climatology_" + str(year) +
                "_all_lead_time_windows_" + str((time_windows - 1) * 2 + 1), np.array(mae_score))
    np.save("/scratch/iu60/yl3101/DESRGAN/new_crps/save/climatology/relative_bias_climatology_" + str(year) +
                "_all_lead_time_windows_" + str((time_windows - 1) * 2 + 1), np.array(mean_bias_relative_model_3))
    np.save("/scratch/iu60/yl3101/DESRGAN/new_crps/save/climatology/bias_climatology_" + str(year) +
