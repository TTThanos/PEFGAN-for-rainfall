...
def main(year, days):
    ...
    parser.add_argument('--file_ACCESS_dir', type=str, default="/scratch/iu60/rh4668/vdsr_one_crps/eval/2012/", help='dataset directory')
    ...
    for lead in range(0, days):
        ...
        if not os.path.exists("/scratch/iu60/rh4668/score/save/crps_ss/VDSR_ONE_L1/" + str(year)):
            os.mkdir("/scratch/iu60/rh4668/score/save/crps_ss/VDSR_ONE_L1/" + str(year))
