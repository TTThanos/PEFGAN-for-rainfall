...
def main(year, days):
    ...
    # hyper-parameters
    parser.add_argument('--train_name', type=str, default="BI", help='training name')
    ...
    parser.add_argument('--file_ACCESS_dir', type=str, default="/scratch/iu60/rh4668/test_data/2002/", help='dataset directory')
    ...
    for lead in range(0, days):
        ...
        if not os.path.exists("/scratch/iu60/rh4668/score/save/mae/BI/" + str(year)):
            os.mkdir("/scratch/iu60/rh4668/score/save/mae/BI/" + str(year))
        np.save("/scratch/iu60/rh4668/score/save/mae/BI/" + str(year) + "/lead_time" + str(lead) + '_whole',
                np.mean(mean_mae_model, axis=0))

        if not os.path.exists("/scratch/iu60/rh4668/score/save/bias/BI/" + str(year)):
            os.mkdir("/scratch/iu60/rh4668/score/save/bias/BI/" + str(year))
        np.save("/scratch/iu60/rh4668/score/save/bias/BI/" + str(year) + "/lead_time" + str(lead) + '_whole',
                np.mean(mean_bias_model, axis=0))

        if not os.path.exists("/scratch/iu60/rh4668/score/save/bias_median/BI/" + str(year)):
            os.mkdir("/scratch/iu60/rh4668/score/save/bias_median/BI/" + str(year))
        np.save("/scratch/iu60/rh4668/score/save/bias_median/BI/" + str(year) + "/lead_time" + str(lead) + '_whole',
                np.mean(mean_bias_median_model, axis=0))

        if not os.path.exists("/scratch/iu60/rh4668/score/save/rmse/BI/" + str(year)):
            os.mkdir("/scratch/iu60/rh4668/score/save/rmse/BI/" + str(year))
        np.save("/scratch/iu60/rh4668/score/save/rmse/BI/" + str(year) + "/lead_time" + str(lead) + '_whole',
                np.mean(mean_rmse_model, axis=0))

        if not os.path.exists("/scratch/iu60/rh4668/score/save/crps_ss/BI/" + str(year)):
            os.mkdir("/scratch/iu60/rh4668/score/save/crps_ss/BI/" + str(year))
        np.save("/scratch/iu60/rh4668/score/save/crps_ss/BI/" + str(year) + "/lead_time" + str(lead) + '_whole',
                np.mean(mean_crps_model, axis=0))

        if not os.path.exists("/scratch/iu60/rh4668/score/save/mae_mean/BI/" + str(year)):
            os.mkdir("/scratch/iu60/rh4668/score/save/mae_mean/BI/" + str(year))
        np.save("/scratch/iu60/rh4668/score/save/mae_mean/BI/" + str(year) + "/lead_time" + str(lead) + '_whole',
                np.mean(mae_mean_score_model, axis=0))

        if not os.path.exists("/scratch/iu60/rh4668/score/save/mae_median/BI/" + str(year)):
            os.mkdir("/scratch/iu60/rh4668/score/save/mae_median/BI/" + str(year))
        np.save("/scratch/iu60/rh4668/score/save/mae_median/BI/" + str(year) + "/lead_time" + str(lead) + '_whole',
