...
def main(year, days):
    ...
    parser.add_argument('--file_ACCESS_dir', type=str, default="/scratch/iu60/rh4668/VDSR/eval/2002/", help='dataset directory')
    ...
    for lead in range(0, days):
        ...
        if not os.path.exists("/scratch/iu60/rh4668/score/save/crps_ss/VDSR_L1/" + str(year)):
            os.mkdir("/scratch/iu60/rh4668/score/save/crps_ss/VDSR_L1/" + str(year))
        np.save("/scratch/iu60/rh4668/score/save/crps_ss/VDSR_L1/" + str(year) + "/lead_time" + str(lead) + '_whole',
                np.mean(mean_crps_model, axis=0))

        if not os.path.exists("/scratch/iu60/rh4668/score/save/mae_mean/VDSR_L1/" + str(year)):
            os.mkdir("/scratch/iu60/rh4668/score/save/mae_mean/VDSR_L1/" + str(year))
        np.save("/scratch/iu60/rh4668/score/save/mae_mean/VDSR_L1/" + str(year) + "/lead_time" + str(lead) + '_whole',
                np.mean(mae_mean_score_model, axis=0))

        if not os.path.exists("/scratch/iu60/rh4668/score/save/mae_median/VDSR_L1/" + str(year)):
            os.mkdir("/scratch/iu60/rh4668/score/save/mae_median/VDSR_L1/" + str(year))
