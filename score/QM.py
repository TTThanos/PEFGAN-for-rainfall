...
def main(year, days):
    ...
    parser.add_argument('--file_ACCESS_dir', type=str, default="/g/data/ux62/access-s2/hindcast/calibrated/atmos/pr/daily/", help='dataset directory')
    ...
    for lead in range(0, days):
        ...
        for batch, (pr, hr,  _, _, _) in enumerate(test_data):
            ...
            with torch.set_grad_enabled(False):
                ...
                for i in range(sr_np.shape[0] // args.ensemble):
                    a = np.squeeze(
        ...
        if not os.path.exists("/scratch/iu60/rh4668/score/save/mae/QM/" + str(year)):
            os.mkdir("/scratch/iu60/rh4668/score/save/mae/QM/" + str(year))
        np.save("/scratch/iu60/rh4668/score/save/mae/QM/" + str(year) + "/lead_time" + str(lead) + '_whole',
                np.mean(mean_mae_model, axis=0))

        if not os.path.exists("/scratch/iu60/rh4668/score/save/bias/QM/" + str(year)):
            os.mkdir("/scratch/iu60/rh4668/score/save/bias/QM/" + str(year))
        np.save("/scratch/iu60/rh4668/score/save/bias/QM/" + str(year) + "/lead_time" + str(lead) + '_whole',
                np.mean(mean_bias_model, axis=0))

        if not os.path.exists("/scratch/iu60/rh4668/score/save/bias_median/QM/" + str(year)):
            os.mkdir("/scratch/iu60/rh4668/score/save/bias_median/QM/" + str(year))
        np.save("/scratch/iu60/rh4668/score/save/bias_median/QM/" + str(year) + "/lead_time" + str(lead) + '_whole',
                np.mean(mean_bias_median_model, axis=0))

        if not os.path.exists("/scratch/iu60/rh4668/score/save/rmse/QM/" + str(year)):
            os.mkdir("/scratch/iu60/rh4668/score/save/rmse/QM/" + str(year))
        np.save("/scratch/iu60/rh4668/score/save/rmse/QM/" + str(year) + "/lead_time" + str(lead) + '_whole',
                np.mean(mean_rmse_model, axis=0))

        if not os.path.exists("/scratch/iu60/rh4668/score/save/crps_ss/QM/" + str(year)):
            os.mkdir("/scratch/iu60/rh4668/score/save/crps_ss/QM/" + str(year))
        np.save("/scratch/iu60/rh4668/score/save/crps_ss/QM/" + str(year) + "/lead_time" + str(lead) + '_whole',
                np.mean(mean_crps_model, axis=0))

        if not os.path.exists("/scratch/iu60/rh4668/score/save/mae_mean/QM/" + str(year)):
            os.mkdir("/scratch/iu60/rh4668/score/save/mae_mean/QM/" + str(year))
        np.save("/scratch/iu60/rh4668/score/save/mae_mean/QM/" + str(year) + "/lead_time" + str(lead) + '_whole',
                np.mean(mae_mean_score_model, axis=0))

        if not os.path.exists("/scratch/iu60/rh4668/score/save/mae_median/QM/" + str(year)):
            os.mkdir("/scratch/iu60/rh4668/score/save/mae_median/QM/" + str(year))
        np.save("/scratch/iu60/rh4668/score/save/mae_median/QM/" + str(year) + "/lead_time" + str(lead) + '_whole',
